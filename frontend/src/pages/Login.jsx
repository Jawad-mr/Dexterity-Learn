...
import { Mail, Lock, LogIn, AlertCircle, Heart, GraduationCap, Terminal, BookOpen, Award, ArrowLeft } from 'lucide-react';
      ...
      <div className="flex-1 lg:col-span-3 flex items-center justify-center p-6 md:p-12">
        <div className="w-full max-w-sm space-y-6">
          ...
          <div className="flex justify-between items-center">
            <button
              onClick={() => navigate('/')}
              className="flex items-center gap-1 text-[11px] font-black bg-white dark:bg-slate-900 text-slate-950 dark:text-white px-3 py-1.5 border-2 border-slate-950 dark:border-slate-800 rounded-xl shadow-flat-sm active:translate-y-[1px] active:shadow-none transition-all w-fit"
            >
          ...
          <div className="flex bg-slate-150 dark:bg-slate-900 border-2 border-slate-950 rounded-2xl p-1 shadow-flat-sm">
            <button
              ...
              className="flex-1 py-2 text-center text-xs font-black rounded-xl bg-white border-2 border-slate-950 shadow-flat-sm text-slate-955"
            >
              Sign In
            </button>
            <button
